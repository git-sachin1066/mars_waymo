        ...
        pipeline=MarsPipelineConfig(
            datamanager=MarsDataManagerConfig(
                dataparser=MarsKittiDataParserConfig(
                    ...
                    use_depth=True,
                    car_object_latents_path=Path(
                        "/home/sachinv/sachin/nerfs/shaira/data/kitti/training/latent_codes06.pt"
                    ),
                    split_setting="reconstruction",
                    car_nerf_state_dict_path=Path("/home/sachinv/sachin/nerfs/shaira/data/kitti/training/epoch_670.ckpt"),
                    scale_factor=0.1,
                ),
                train_num_rays_per_batch=4096,
                eval_num_rays_per_batch=4096,
        ...
        pipeline=MarsPipelineConfig(
            datamanager=MarsDataManagerConfig(
                dataparser=MarsVKittiDataParserConfig(
                    ...
                    use_depth=True,
                    car_object_latents_path=Path(
                        "/home/sachinv/sachin/paper2/other_implementataion/impl/mars/vkitti/latent_codes18.pt"
                        # "/DATA_EDS/liuty/ckpts/pretrain/car_nerf/vkitti/latents/latent_codes02.pt"
                    ),
                    split_setting="reconstruction",
                    car_nerf_state_dict_path=Path("/home/sachinv/sachin/paper2/other_implementataion/impl/mars/vkitti/epoch_670.ckpt"),
                ),
                train_num_rays_per_batch=4096,
                eval_num_rays_per_batch=4096,
                camera_optimizer=CameraOptimizerConfig(mode="off"),
